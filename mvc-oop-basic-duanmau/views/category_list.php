<?php
    $page_title = "Quản lý Danh mục Tour";
    $categories = [
        ['id' => 1, 'code' => 'DOMESTIC', 'name' => 'Tour Trong nước', 'count' => 15],
        ['id' => 2, 'code' => 'INTERNATIONAL', 'name' => 'Tour Quốc tế', 'count' => 8],
        ['id' => 3, 'code' => 'BEACH', 'name' => 'Tour Biển đảo', 'count' => 5],
    ];
?>
<!DOCTYPE html>
<html lang="vi">
<head>
    ...
    <style>
        ...
        .btn-add { background-color: #17a2b8; border-color: #17a2b8; color: white; font-weight: bold; }
        .category-table th { font-weight: bold; background-color: #e9ecef; color: #6c757d; }
    </style>
</head>
<body>
...
<div class="sidebar">
    ...
    <ul class="nav flex-column">
        ...
        <li class="nav-item"><a class="nav-link active" href="index.php?act=category_list"><i class="fas fa-stream"></i> Danh mục tour</a></li>
...
<div class="main-content">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div class="input-group" style="width: 300px;">
            <input type="text" class="form-control" placeholder="Tìm kiếm danh mục..." name="search_category">
            <button class="btn btn-outline-secondary" type="submit"><i class="fas fa-search"></i></button>
        </div>
        <a href="#" class="btn btn-add d-flex align-items-center" data-bs-toggle="modal" data-bs-target="#addCategoryModal">
                ...
                <table class="table table-hover mb-0 category-table">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" style="width: 15%;" class="text-center">Số lượng Tour</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="category_form.php?id=<?php echo $cat['id']; ?>" class="text-info me-2" title="Sửa"><i class="fas fa-edit"></i></a>
                                <a href="delete_category.php?id=<?php echo $cat['id']; ?>" class="text-danger" title="Xóa" onclick="return confirm('Bạn có chắc chắn muốn xóa danh mục này?');"><i class="fas fa-trash-alt"></i></a>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
            ...
            <div class="modal-content">
                <form method="POST" action="process_category.php">
                    <div class="modal-header">
                        <h5 class="modal-title" id="addCategoryModalLabel">Thêm Danh mục Tour</h5>
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                         ...
                         <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="categoryCode" name="category_code">
                        </div>
                    </div>
